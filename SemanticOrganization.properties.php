...
class SemanticOrganizationProperties {
	static $properties = [
		...
		"person" => [ "id" => "P","fields" => ["ref" => [ "id" => "RF","type" => "wpg" ],"birthday" => [ "id" => "BD","type" => "dat" ],"profession" => [ "id" => "PR","type" => "txt" ],"workaddress" => [ "id" => "WAD","type" => "txt" ],"ssn" => [ "id" => "SS","type" => "txt" ],"email" => [ "id" => "EM","type" => "ema" ],"membership-end" => [ "id" => "MEE","type" => "dat" ],"prefix" => [ "id" => "PF","type" => "txt" ],"birthplace" => [ "id" => "BP","type" => "txt" ],"tax-number" => [ "id" => "TN","type" => "txt" ],"homepage" => [ "id" => "HP","type" => "uri" ],"legal-form" => [ "id" => "LF","type" => "txt" ],"worklocality" => [ "id" => "WLO","type" => "txt" ],"personnel" => [ "id" => "PE","type" => "boo" ],"firstname" => [ "id" => "FN","type" => "txt" ],"iban" => [ "id" => "IB","type" => "txt" ],"acronym" => [ "id" => "AC","type" => "txt" ],"organization" => [ "id" => "OR","type" => "txt" ],"legal-registry" => [ "id" => "LR","type" => "txt" ],"workstreet" => [ "id" => "WST","type" => "txt" ],"personnel-number" => [ "id" => "PEN","type" => "num" ],"lastname" => [ "id" => "LN","type" => "txt" ],"membership" => [ "id" => "ME","type" => "boo" ],"note" => [ "id" => "NT","type" => "txt" ],"tag" => [ "id" => "TA","type" => "txt" ],"workpostalcode" => [ "id" => "WPC","type" => "txt" ],"personnel-start" => [ "id" => "PES","type" => "dat" ],"suffix" => [ "id" => "SF","type" => "txt" ],"membership-number" => [ "id" => "MEN","type" => "num" ],"gender" => [ "id" => "GD","type" => "txt" ],"vat-number" => [ "id" => "VAT","type" => "txt" ],"workphone" => [ "id" => "WPH","type" => "tel" ],"personnel-end" => [ "id" => "PEE","type" => "dat" ],"name" => [ "id" => "NA","type" => "txt" ],"membership-start" => [ "id" => "MES","type" => "dat" ], ] ],
		...
		"project" => [ "id" => "PJ","fields" => ["strategic-objective" => [ "id" => "SO","type" => "txt" ],"title" => [ "id" => "TT","type" => "txt" ],"budget" => [ "id" => "BU","type" => "num" ],"closed" => [ "id" => "CL","type" => "boo" ],"status" => [ "id" => "SU","type" => "txt" ],"start" => [ "id" => "ST","type" => "dat" ],"openproject-id" => [ "id" => "OP","type" => "num" ],"short-title" => [ "id" => "SH","type" => "txt" ],"end" => [ "id" => "EN","type" => "dat" ],"toggl-id" => [ "id" => "TO","type" => "num" ],"description" => [ "id" => "DE","type" => "txt" ],"contact-person" => [ "id" => "CP","type" => "wpg" ],"target-group" => [ "id" => "TG","type" => "txt" ],"department" => [ "id" => "DP","type" => "wpg" ],"team-internal" => [ "id" => "TI","type" => "wpg" ],"phase" => [ "id" => "PH","type" => "txt" ],"milestone" => [ "id" => "MI","type" => "wpg" ],"team-external" => [ "id" => "TE","type" => "wpg" ], ] ],
		...
		"scj" => [ "id" => "SCJ","fields" => ["name" => [ "id" => "NA","type" => "txt" ],"targeted-sc" => [ "id" => "TSC","type" => "txt" ],"targeted-sc-long" => [ "id" => "TSL","type" => "txt" ], ] ],
