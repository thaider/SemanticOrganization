...
class SemanticOrganizationProperties {
	static $properties = [
		...
		"person" => [ "id" => "P","fields" => ["birthday" => [ "id" => "BD","type" => "dat" ],"ref" => [ "id" => "RF","type" => "wpg" ],"ssn" => [ "id" => "SS","type" => "txt" ],"workaddress" => [ "id" => "WAD","type" => "txt" ],"membership-end" => [ "id" => "MEE","type" => "dat" ],"email" => [ "id" => "EM","type" => "ema" ],"birthplace" => [ "id" => "BP","type" => "txt" ],"prefix" => [ "id" => "PF","type" => "txt" ],"legal-form" => [ "id" => "LF","type" => "txt" ],"homepage" => [ "id" => "HP","type" => "uri" ],"personnel" => [ "id" => "PE","type" => "boo" ],"worklocality" => [ "id" => "WLO","type" => "txt" ],"iban" => [ "id" => "IB","type" => "txt" ],"firstname" => [ "id" => "FN","type" => "txt" ],"legal-registry" => [ "id" => "LR","type" => "txt" ],"organization" => [ "id" => "OR","type" => "txt" ],"personnel-number" => [ "id" => "PEN","type" => "num" ],"workstreet" => [ "id" => "WST","type" => "txt" ],"membership" => [ "id" => "ME","type" => "boo" ],"lastname" => [ "id" => "LN","type" => "txt" ],"tag" => [ "id" => "TA","type" => "txt" ],"note" => [ "id" => "NT","type" => "txt" ],"personnel-start" => [ "id" => "PES","type" => "dat" ],"workpostalcode" => [ "id" => "WPC","type" => "txt" ],"membership-number" => [ "id" => "MEN","type" => "num" ],"suffix" => [ "id" => "SF","type" => "txt" ],"gender" => [ "id" => "GD","type" => "txt" ],"personnel-end" => [ "id" => "PEE","type" => "dat" ],"workphone" => [ "id" => "WPH","type" => "tel" ],"membership-start" => [ "id" => "MES","type" => "dat" ],"name" => [ "id" => "NA","type" => "txt" ], ] ],
