...
class SemanticOrganizationProperties {
	static $properties = [
		...
		"invoice" => [ "id" => "IN","fields" => ["payed" => [ "id" => "PA","type" => "boo" ],"recipient" => [ "id" => "RE","type" => "txt" ],"storno" => [ "id" => "ST","type" => "boo" ],"due-date" => [ "id" => "DD","type" => "dat" ],"issuer" => [ "id" => "IS","type" => "wpg" ],"reminder-1-date" => [ "id" => "R1","type" => "dat" ],"payment-date" => [ "id" => "PD","type" => "dat" ],"number" => [ "id" => "NU","type" => "txt" ],"collection-date" => [ "id" => "CD","type" => "dat" ],"description" => [ "id" => "DS","type" => "txt" ],"date" => [ "id" => "DT","type" => "dat" ],"reminder-2-date" => [ "id" => "R2","type" => "dat" ],"department" => [ "id" => "DE","type" => "wpg" ],"amount-gross" => [ "id" => "AG","type" => "num" ],"year" => [ "id" => "YE","type" => "num" ],"project" => [ "id" => "PJ","type" => "wpg" ],"amount-net" => [ "id" => "AN","type" => "num" ], ] ],
		...
		"person" => [ "id" => "P","fields" => ["birthday" => [ "id" => "BD","type" => "dat" ],"ref" => [ "id" => "RF","type" => "wpg" ],"ssn" => [ "id" => "SS","type" => "txt" ],"workaddress" => [ "id" => "WAD","type" => "txt" ],"membership-end" => [ "id" => "MEE","type" => "dat" ],"email" => [ "id" => "EM","type" => "ema" ],"birthplace" => [ "id" => "BP","type" => "txt" ],"prefix" => [ "id" => "PF","type" => "txt" ],"legal-form" => [ "id" => "LF","type" => "txt" ],"homepage" => [ "id" => "HP","type" => "uri" ],"personnel" => [ "id" => "PE","type" => "boo" ],"worklocality" => [ "id" => "WLO","type" => "txt" ],"iban" => [ "id" => "IB","type" => "txt" ],"firstname" => [ "id" => "FN","type" => "txt" ],"legal-registry" => [ "id" => "LR","type" => "txt" ],"organization" => [ "id" => "OR","type" => "txt" ],"personnel-number" => [ "id" => "PEN","type" => "num" ],"workstreet" => [ "id" => "WST","type" => "txt" ],"membership" => [ "id" => "ME","type" => "boo" ],"lastname" => [ "id" => "LN","type" => "txt" ],"tag" => [ "id" => "TA","type" => "txt" ],"note" => [ "id" => "NT","type" => "txt" ],"personnel-start" => [ "id" => "PES","type" => "dat" ],"workpostalcode" => [ "id" => "WPC","type" => "txt" ],"membership-number" => [ "id" => "MEN","type" => "num" ],"suffix" => [ "id" => "SF","type" => "txt" ],"vat-number" => [ "id" => "VAT","type" => "txt" ],"gender" => [ "id" => "GD","type" => "txt" ],"personnel-end" => [ "id" => "PEE","type" => "dat" ],"workphone" => [ "id" => "WPH","type" => "tel" ],"membership-start" => [ "id" => "MES","type" => "dat" ],"name" => [ "id" => "NA","type" => "txt" ], ] ],
