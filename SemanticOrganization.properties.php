...
class SemanticOrganizationProperties {
	static $properties = [
		...
		"person" => [ "id" => "P","fields" => ["birthday" => [ "id" => "BD","type" => "dat" ],"profession" => [ "id" => "PR","type" => "txt" ],"ref" => [ "id" => "RF","type" => "wpg" ],"workaddress" => [ "id" => "WAD","type" => "txt" ],"ssn" => [ "id" => "SS","type" => "txt" ],"email" => [ "id" => "EM","type" => "ema" ],"membership-end" => [ "id" => "MEE","type" => "dat" ],"birthplace" => [ "id" => "BP","type" => "txt" ],"tax-number" => [ "id" => "TN","type" => "txt" ],"prefix" => [ "id" => "PF","type" => "txt" ],"homepage" => [ "id" => "HP","type" => "uri" ],"legal-form" => [ "id" => "LF","type" => "txt" ],"worklocality" => [ "id" => "WLO","type" => "txt" ],"personnel" => [ "id" => "PE","type" => "boo" ],"iban" => [ "id" => "IB","type" => "txt" ],"firstname" => [ "id" => "FN","type" => "txt" ],"organization" => [ "id" => "OR","type" => "txt" ],"legal-registry" => [ "id" => "LR","type" => "txt" ],"workstreet" => [ "id" => "WST","type" => "txt" ],"personnel-number" => [ "id" => "PEN","type" => "num" ],"membership" => [ "id" => "ME","type" => "boo" ],"lastname" => [ "id" => "LN","type" => "txt" ],"note" => [ "id" => "NT","type" => "txt" ],"tag" => [ "id" => "TA","type" => "txt" ],"workpostalcode" => [ "id" => "WPC","type" => "txt" ],"personnel-start" => [ "id" => "PES","type" => "dat" ],"suffix" => [ "id" => "SF","type" => "txt" ],"membership-number" => [ "id" => "MEN","type" => "num" ],"gender" => [ "id" => "GD","type" => "txt" ],"vat-number" => [ "id" => "VAT","type" => "txt" ],"workphone" => [ "id" => "WPH","type" => "tel" ],"personnel-end" => [ "id" => "PEE","type" => "dat" ],"name" => [ "id" => "NA","type" => "txt" ],"membership-start" => [ "id" => "MES","type" => "dat" ], ] ],
		...
		"plot" => [ "id" => "PL","fields" => ["number" => [ "id" => "NU","type" => "num" ],"name" => [ "id" => "NA","type" => "txt" ],"description" => [ "id" => "DE","type" => "txt" ],"scj" => [ "id" => "SCJ","type" => "wpg" ], ] ],
		"process" => [ "id" => "PS","fields" => ["title" => [ "id" => "TI","type" => "txt" ],"description" => [ "id" => "DE","type" => "txt" ],"owner" => [ "id" => "OW","type" => "wpg" ],"visualization" => [ "id" => "VI","type" => "wpg" ], ] ],
		"project" => [ "id" => "PJ","fields" => ["title" => [ "id" => "TT","type" => "txt" ],"budget" => [ "id" => "BU","type" => "num" ],"closed" => [ "id" => "CL","type" => "boo" ],"start" => [ "id" => "ST","type" => "dat" ],"short-title" => [ "id" => "SH","type" => "txt" ],"end" => [ "id" => "EN","type" => "dat" ],"description" => [ "id" => "DE","type" => "txt" ],"contact-person" => [ "id" => "CP","type" => "wpg" ],"department" => [ "id" => "DP","type" => "wpg" ],"team-internal" => [ "id" => "TI","type" => "wpg" ],"milestone" => [ "id" => "MI","type" => "wpg" ],"team-external" => [ "id" => "TE","type" => "wpg" ], ] ],
		"project-grant" => [ "id" => "PG","fields" => ["project" => [ "id" => "PR","type" => "wpg" ],"amount" => [ "id" => "AM","type" => "num" ],"grantor" => [ "id" => "GR","type" => "wpg" ],"de-minimis" => [ "id" => "DM","type" => "boo" ],"acceptance-date" => [ "id" => "AD","type" => "dat" ],"title" => [ "id" => "TI","type" => "txt" ], ] ],
		...
		"scj" => [ "id" => "SCJ","fields" => ["name" => [ "id" => "NA","type" => "txt" ],"targeted-sc" => [ "id" => "TSC","type" => "txt" ], ] ],
