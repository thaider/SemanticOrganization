...
class SemanticOrganizationProperties {
	static $properties = [
		...
		"transfer" => [ "id" => "TR","fields" => ["sender" => [ "id" => "SE","type" => "wpg" ],"list" => [ "id" => "LI","type" => "wpg" ],"recipient" => [ "id" => "RE","type" => "wpg" ],"listed" => [ "id" => "LD","type" => "boo" ],"amount" => [ "id" => "AM","type" => "num" ],"date" => [ "id" => "DA","type" => "dat" ],"details" => [ "id" => "DE","type" => "txt" ],"subject" => [ "id" => "SU","type" => "txt" ], ] ],
