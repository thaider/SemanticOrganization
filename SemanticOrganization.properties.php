...
class SemanticOrganizationProperties {
	static $properties = [
		...
		"person" => [ "id" => "P","fields" => ["birthday" => [ "id" => "BD","type" => "dat" ],"ref" => [ "id" => "RF","type" => "wpg" ],"workaddress" => [ "id" => "WAD","type" => "txt" ],"ssn" => [ "id" => "SS","type" => "txt" ],"email" => [ "id" => "EM","type" => "ema" ],"membership-end" => [ "id" => "MEE","type" => "dat" ],"birthplace" => [ "id" => "BP","type" => "txt" ],"prefix" => [ "id" => "PF","type" => "txt" ],"homepage" => [ "id" => "HP","type" => "uri" ],"legal-form" => [ "id" => "LF","type" => "txt" ],"worklocality" => [ "id" => "WLO","type" => "txt" ],"personnel" => [ "id" => "PE","type" => "boo" ],"iban" => [ "id" => "IB","type" => "txt" ],"firstname" => [ "id" => "FN","type" => "txt" ],"organization" => [ "id" => "OR","type" => "txt" ],"legal-registry" => [ "id" => "LR","type" => "txt" ],"workstreet" => [ "id" => "WST","type" => "txt" ],"personnel-number" => [ "id" => "PEN","type" => "num" ],"membership" => [ "id" => "ME","type" => "boo" ],"lastname" => [ "id" => "LN","type" => "txt" ],"note" => [ "id" => "NT","type" => "txt" ],"tag" => [ "id" => "TA","type" => "txt" ],"workpostalcode" => [ "id" => "WPC","type" => "txt" ],"personnel-start" => [ "id" => "PES","type" => "dat" ],"suffix" => [ "id" => "SF","type" => "txt" ],"membership-number" => [ "id" => "MEN","type" => "num" ],"gender" => [ "id" => "GD","type" => "txt" ],"workphone" => [ "id" => "WPH","type" => "tel" ],"personnel-end" => [ "id" => "PEE","type" => "dat" ],"name" => [ "id" => "NA","type" => "txt" ],"membership-start" => [ "id" => "MES","type" => "dat" ], ] ],
