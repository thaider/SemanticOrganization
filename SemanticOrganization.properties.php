...
class SemanticOrganizationProperties {
	static $properties = [
		...
		"expense" => [ "id" => "EX","fields" => ["expense-report" => [ "id" => "ER","type" => "wpg" ],"date" => [ "id" => "DA","type" => "dat" ],"project" => [ "id" => "PR","type" => "wpg" ],"description" => [ "id" => "DE","type" => "txt" ],"amount-gross" => [ "id" => "AG","type" => "num" ],"amount-net" => [ "id" => "AN","type" => "num" ], ] ],
		...
		"meeting" => [ "id" => "M","fields" => ["group" => [ "id" => "GR","type" => "wpg" ],"vote-counter" => [ "id" => "VC","type" => "wpg" ],"guest" => [ "id" => "GU","type" => "wpg" ],"participant" => [ "id" => "PA","type" => "wpg" ],"project" => [ "id" => "PR","type" => "wpg" ],"chair" => [ "id" => "CH","type" => "wpg" ],"participant-board" => [ "id" => "PB","type" => "wpg" ],"excused" => [ "id" => "EX","type" => "wpg" ],"department" => [ "id" => "DE","type" => "wpg" ],"number" => [ "id" => "NU","type" => "num" ],"secretary" => [ "id" => "SE","type" => "wpg" ],"date" => [ "id" => "DT","type" => "dat" ],"type" => [ "id" => "TY","type" => "txt" ],"moderator" => [ "id" => "MO","type" => "wpg" ],"time" => [ "id" => "TI","type" => "txt" ],"signer" => [ "id" => "SI","type" => "wpg" ],"overview" => [ "id" => "OV","type" => "txt" ],"location" => [ "id" => "LO","type" => "txt" ], ] ],
		...
		"project-team" => [ "id" => "PT","fields" => ["project" => [ "id" => "PR","type" => "wpg" ],"team-external" => [ "id" => "TE","type" => "wpg" ],"role" => [ "id" => "RO","type" => "txt" ],"start-date" => [ "id" => "SD","type" => "dat" ],"end-date" => [ "id" => "ED","type" => "dat" ],"team" => [ "id" => "TE","type" => "wpg" ],"team-internal" => [ "id" => "TI","type" => "wpg" ], ] ],
